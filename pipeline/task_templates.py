...
TASK_TEMPLATES: Dict[str, Dict[str, Any]] = {
    ...
    "jit_escalation": {
        ...
        "subgoals": [
            ...
            {"id": "sg_attach_ticket",      "description": "Attach the incident ticket as justification for the escalation",     "reward": 0.10},
            {"id": "sg_set_ttl",            "description": "Configure the TTL for the temporary access grant if activating",        "reward": 0.10},
            {"id": "sg_activate_grant",     "description": "Make the final decision: activate the grant or deny if conditions fail", "reward": 0.40},
        ],
        "grading_weights": {
    ...
    "emergency_breakglass": {
        ...
        "subgoals": [
            {"id": "sg_verify_incident",  "description": "Verify the incident details to assess whether break-glass access is warranted",         "reward": 0.10},
            {"id": "sg_check_engineer",   "description": "Identify the on-call engineer and their current entitlements",                                "reward": 0.05},
            {"id": "sg_lookup_policy",    "description": "Check the break-glass policy for the affected resource",                                      "reward": 0.10},
            {"id": "sg_attach_ticket",    "description": "Attach the incident ticket as justification for the access decision",                          "reward": 0.10},
            {"id": "sg_flag_security",    "description": "Flag the security team about this break-glass event in the audit log",                        "reward": 0.15},
            {"id": "sg_set_ttl",          "description": "Set the emergency access TTL if activating a grant",                                          "reward": 0.10},
            {"id": "sg_activate_grant",   "description": "Make the final access decision: grant emergency access or deny based on incident validity and policy", "reward": 0.40},
        ],
        "grading_weights": {
            "incident_valid":      0.15,
            "correct_role":        0.15,
    ...
    "multi_agent_oversight": {
        ...
        "subgoals": [
            {"id": "sg_inspect_sub_agents", "description": "Inspect sub-agent identities and their current entitlements",                       "reward": 0.05},
            {"id": "sg_query_graph",        "description": "Query the identity graph or run SoD checks to trace permission paths",              "reward": 0.10},
            {"id": "sg_run_sod_audit",      "description": "Run SoD checks on sub-agents to identify conflicting or dangerous permission pairs", "reward": 0.15},
            {"id": "sg_flag_audit",         "description": "Flag suspicious activity in the audit log",                                          "reward": 0.10},
            {"id": "sg_deny_rogue",         "description": "Block the access request that poses a security risk",                                 "reward": 0.30},
            {"id": "sg_quarantine",         "description": "Isolate the sub-agent posing a security risk",                                        "reward": 0.20},
            {"id": "sg_approve_legit",      "description": "Correctly handle legitimate access requests from other agents",                        "reward": 0.10},
        ],
        "grading_weights": {
